...
if __name__ == "__main__":
    ...
    #########################################################
    #Que te mande el anterior si es cero que sea el último
    #########################################################
    ...
    #################################################################
    # send recv son operaciones bloquedas y generan que el codigo se
    # atore esperando que alguien reciba un mensaje esto se resuelve
    ...
    if rank%2==0:
        ########################
        #Envia mensaje al dest
        ########################
        comm.send(s, dest= destino)

        #################################
        #Recibe de source y lo pone en m 
        #################################
